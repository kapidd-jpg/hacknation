...
class DemoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kelasRows = [
            ['slug' => 'tps', 'name' => 'TPS Penalaran Umum', 'cat' => 'UTBK-SNBT', 'ico' => 'PU', 'meta' => 'Kelas 12 · Persiapan UTBK', 'desc' => 'Logika, analisis, dan penalaran kuantitatif berpola SNBT.', 'modul' => 32, 'durasi' => '12 Minggu', 'price' => 599000, 'old' => 799000, 'bg' => 'rgba(126,252,154,0.35)', 'color' => '#007433'],
            ['slug' => 'literasi', 'name' => 'Literasi Bahasa Indonesia', 'cat' => 'UTBK-SNBT', 'ico' => 'BI', 'meta' => 'Kelas 12 · Persiapan UTBK', 'desc' => 'Teknik membaca cepat dan inferensi untuk teks panjang.', 'modul' => 28, 'durasi' => '10 Minggu', 'price' => 499000, 'old' => 699000, 'bg' => 'rgba(222,225,255,1)', 'color' => '#111c4e'],
            ['slug' => 'matematika', 'name' => 'Matematika Saintek', 'cat' => 'UTBK-SNBT', 'ico' => 'MS', 'meta' => 'Kelas 12 · Saintek', 'desc' => 'Integral, trigonometri, statistika dengan trik cepat 20 detik.', 'modul' => 30, 'durasi' => '12 Minggu', 'price' => 649000, 'old' => 849000, 'bg' => 'rgba(254,243,199,1)', 'color' => '#92400e'],
            ['slug' => 'fisika', 'name' => 'Fisika Mekanika', 'cat' => 'SMA', 'ico' => 'FM', 'meta' => 'Kelas 11 · Wajib & Peminatan', 'desc' => 'Kinematika, dinamika, dan energi dengan pendekatan visual.', 'modul' => 24, 'durasi' => '10 Minggu', 'price' => 449000, 'old' => 599000, 'bg' => 'rgba(237,233,254,1)', 'color' => '#6d28d9'],
            ['slug' => 'kimia', 'name' => 'Kimia Dasar & Stoikiometri', 'cat' => 'SMA', 'ico' => 'KN', 'meta' => 'Kelas 10-11 · Wajib', 'desc' => 'Perhitungan kimia dan konsep mol yang dibuat simpel.', 'modul' => 22, 'durasi' => '9 Minggu', 'price' => 399000, 'old' => 549000, 'bg' => 'rgba(126,252,154,0.35)', 'color' => '#007433'],
            ['slug' => 'biologi', 'name' => 'Biologi Sel & Genetika', 'cat' => 'SMA', 'ico' => 'BG', 'meta' => 'Kelas 12 · Peminatan Saintek', 'desc' => 'Sel, hereditas, dan bioteknologi dengan peta konsep.', 'modul' => 26, 'durasi' => '10 Minggu', 'price' => 429000, 'old' => 579000, 'bg' => 'rgba(222,225,255,1)', 'color' => '#111c4e'],
            ['slug' => 'toefl', 'name' => 'TOEFL & English Daily', 'cat' => 'Bahasa', 'ico' => 'TR', 'meta' => 'Semua jenjang', 'desc' => 'Naikkan skor TOEFL dan percakapan harian.', 'modul' => 20, 'durasi' => '8 Minggu', 'price' => 529000, 'old' => 699000, 'bg' => 'rgba(254,243,199,1)', 'color' => '#92400e'],
            ['slug' => 'inggris-literasi', 'name' => 'Bahasa Inggris Literasi', 'cat' => 'Bahasa', 'ico' => 'IV', 'meta' => 'Kelas 12 · UTBK', 'desc' => 'Reading comprehension dan grammar level HOTS SNBT.', 'modul' => 24, 'durasi' => '10 Minggu', 'price' => 469000, 'old' => 629000, 'bg' => 'rgba(222,225,255,1)', 'color' => '#111c4e'],
            ['slug' => 'python', 'name' => 'Coding Python Dasar', 'cat' => 'Ekstra', 'ico' => 'PY', 'meta' => 'Ekstra · Maks 25 siswa', 'desc' => 'Logika pemrograman dan sains data untuk pemula.', 'modul' => 18, 'durasi' => '8 Minggu', 'price' => 399000, 'old' => 499000, 'bg' => 'rgba(237,233,254,1)', 'color' => '#6d28d9'],
            ['slug' => 'web-design', 'name' => 'Web Design & UI/UX', 'cat' => 'Ekstra', 'ico' => 'WD', 'meta' => 'Ekstra · Studio Kreatif', 'desc' => 'Dari wireframe sampai prototype interaktif.', 'modul' => 16, 'durasi' => '7 Minggu', 'price' => 349000, 'old' => 449000, 'bg' => 'rgba(222,225,255,1)', 'color' => '#111c4e'],
        ];
