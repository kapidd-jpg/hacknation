...
<div class="page-hero">
    ...
    <h1 class="page-hero-title">Mendampingi Setiap Siswa Menuju Kampus Pilihannya</h1>
    <p class="page-hero-sub">Kami percaya bimbingan berkualitas bukan milik segelintir siswa. PintarKuy hadir untuk menjembatani jarak, waktu, dan biaya yang selama ini menghalangi.</p>
...
<section class="pk-section pk-section--white">
    <div class="pk-container">
        <div class="pk-section-head pk-reveal">
            ...
            <p>Di balik setiap fitur dan materi, ada prinsip yang kami pegang.</p>
        </div>

        <div class="tentang-story-grid">
            @php
                $stories = [
                    ['icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'label' => 'Misi', 'title' => 'Bimbingan Berkualitas untuk Semua', 'desc' => 'Akses bimbingan yang dulu hanya dirasakan segelintir orang sekarang terbuka untuk semua siswa, dari Sabang sampai Merauke.', 'color' => 'green'],
                    ['icon' => 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z', 'label' => 'Visi', 'title' => 'Platform Nasional #1 untuk Persiapan Ujian', 'desc' => 'Membangun sistem belajar adaptif berbasis data yang bisa membaca potensi akademik siswa dan membantu naiknya kemampuan mereka di setiap sesi.', 'color' => 'navy'],
                    ['icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'label' => 'Komitmen', 'title' => 'Hasil, Bukan Janji', 'desc' => 'Setiap klaim yang kami sampaikan selalu diuji dengan data. Kami transparan soal statistik kelulusan, skor rata-rata, dan kepuasan siswa.', 'color' => 'amber'],
                    ['icon' => 'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1a4 4 0 10-4-4 4 4 0 004 4zm6 0a4 4 0 10-4-4 4 4 0 004 4z', 'label' => 'Komunitas', 'title' => 'Siswa Membantu Siswa', 'desc' => 'Forum diskusi antar siswa dan tutor membentuk suasana belajar yang aktif tanpa terasa kaku.', 'color' => 'purple'],
                ];
            @endphp
...
<section class="pk-section pk-section--muted">
    <div class="pk-container">
        <div class="pk-cta pk-reveal">
            ...
            <p>Mulai dari paket yang paling sesuai targetmu. Belajar dengan sistem adaptif yang benar-benar memahami kemampuanmu, tanpa kontrak dan bisa berhenti kapan saja.</p>
