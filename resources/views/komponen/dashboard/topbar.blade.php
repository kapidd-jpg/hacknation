<header class="sticky top-0 z-30 h-20 bg-white/90 backdrop-blur shadow-[0px_1px_8px_0px_rgba(15,27,76,0.04)] flex items-center justify-between px-8 gap-6">
    <div class="flex items-center gap-4 flex-1 min-w-0">
        ...
        <a href="{{ route('home') }}" class="flex items-center justify-center size-10 rounded-full hover:bg-navy-50 transition shrink-0" title="Kembali ke Beranda">
