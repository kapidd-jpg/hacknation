    ...
    <div class="w-full px-6 md:px-12 pt-16 pb-12 flex flex-col gap-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('classes') }}" class="text-white/85 text-sm hover:text-white transition">Simulasi UTBK/SNBT</a>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex gap-6">
                <span class="text-white/85 text-xs">Kebijakan Privasi</span>
                <span class="text-white/85 text-xs">Syarat &amp; Ketentuan</span>
            </div>
        </div>
    </div>
</footer>