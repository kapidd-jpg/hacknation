...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const render = (key) => {
        ...
        if (!sem.rows || sem.rows.length === 0) {
            tbody.innerHTML = `<tr><td colspan="7" class="guru-empty" style="padding:28px;text-align:center;">Belum ada latihan soal pada semester ini.</td></tr>`;
        ...
        sumAvgBadge.textContent = sem.grade === '-' || sem.grade === null ? 'Belum ada' : 'Kategori ' + sem.grade;
